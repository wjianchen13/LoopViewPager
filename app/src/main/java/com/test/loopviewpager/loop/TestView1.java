 ...
 * 转盘提示，倒计时，计数
 */
public class TestView1 extends FrameLayout implements View.OnClickListener, IViews {
    ...
    public TestView1(Context dinoContext) {
        super(dinoContext);
        initView(dinoContext, null);
    }

    public TestView1(Context dinoContext, AttributeSet attrs) {
        super(dinoContext, attrs);
        initView(dinoContext, attrs);
    }

    public TestView1(Context dinoContext, AttributeSet attrs, int defStyleAttr) {
    ...
    private void initView(Context context, AttributeSet attrs) {
        ...
        View view = inflate(context, R.layout.view_test1, this);
